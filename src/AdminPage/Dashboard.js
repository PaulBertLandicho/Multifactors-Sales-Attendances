    ...
    <div style={styles.container}>
      ...
      <div style={styles.grid}>
        ...
        <div
          ...
          onMouseEnter={() => showTooltip(presentCardRef, 'Present Today', presentNames)}
        ...
        <div
          ref={absentCardRef}
          style={{ ...styles.card, cursor: 'default' }}
          onMouseEnter={() => showTooltip(absentCardRef, 'Absent Today', absentNames)}
          onMouseLeave={() => scheduleHideTooltip()}
        >
          <div style={styles.iconWrap}><FiClock size={20} /></div>
          <div>
            <div style={styles.title}>Absent Today</div>
            <div style={styles.value}>{compactNumber(Math.max(0, absentCount))}</div>
          </div>
        </div>
      </div>
